...
bool code_saw()
{
	char code[] = ";Filament used:";
	char *ptr;
	ptr = strtok( cmdbuffer[bufindr], code);    // Primera llamada => Primer token
	return (ptr != NULL);  //Return True if a character was found
}
